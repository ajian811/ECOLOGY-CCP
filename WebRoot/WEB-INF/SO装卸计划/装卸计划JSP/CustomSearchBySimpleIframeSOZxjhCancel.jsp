...
%>
<input class="e8_btn_top_first" value="批量作废" onclick="javascript:getAll();" style="max-width: 100px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;float:right;" title="批量作废" type="button">
...
function getAll() {
    ...
    var comfirmb=comfirm('<%=SystemEnv.getHtmlLabelName(-11364,user.getLanguage())%>');//是否确认作废？
	if(!comfirmb){
	    return;
	}

     jQuery.post("/sapjsp/SOZxjhCancel.jsp",{billids:billids},function(data){
      console.log(data);
...
<%
	String tempsqlquery = "select * from mode_CustomDspField where ismaplocation=1 and isshow=1 and customid="+customid;
