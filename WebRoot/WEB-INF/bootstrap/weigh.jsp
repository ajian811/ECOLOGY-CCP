			...
			<form id="wForm1" name="wForm1">
				<div style="border-style:outset">
					<div style="float:left" style="width:70%;">
						<div class="footer_left" style="width:100%;">
							...
							<table>
								<tr>
									<td>&nbsp;&nbsp; <span
										style="color: red;font-size: 20px;margin-top: 0px;">提入单号：</span>
										<input
										style="font-size:17px;width:150px;font-weight: bold;margin-top: 10px;"
										type="text" id="plate" name="plate" />
									</td>
									<td>&nbsp;&nbsp; <span
										style="color: red;font-size: 20px;margin-top: 0px;">车牌号：</span>
										<input
										style="font-size:17px;width:150px;font-weight: bold;margin-top: 10px;"
										type="text" id="carno1" name="carno1" />
									</td>
									<td>&nbsp;&nbsp; <span
										style="color: red;font-size: 20px;margin-top: 0px">柜（罐）号：</span>
										<input
					...
					<div style="width:20%;float:right;background-color:#c9c9c9">
						...
						<span>提入单是否存在：</span> <input class="input_footer" type="text"
							value="0" id="trdStatus" readonly /> <br /> <span>提入单是否打印：</span>
...
<script type="text/javascript">
	...
	function outweigh() {
		...
		var weight =parseDouble($("#endweight").html());
