...
%>
	<input class="e8_btn_top_first" value="批量打印"
		onclick="javascript:getAll();"
		style="max-width: 100px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; float: right;"
		title="批量打印" type="button">
	...
	<div class="advancedSearchDiv" id="advancedSearchDiv"
		...
		<form id="frmmain" name="frmmain" method="post"
			action="/formmode/search/CustomSearchBySimpleIframe1.jsp?<%=tempquerystring%>">
...
function getAll() {
    ...
    if (billids == "") {
     ...
     jQuery.getJSON("/sapjsp/getAllRequestid.jsp",{billids:billids},function(data){
      console.log(data);
      if(data){
...
function onChangeTemplate(obj) {
	document.frmmain.action = "/formmode/search/CustomSearchBySimpleIframe1.jsp?<%=tempquerystring%>";
