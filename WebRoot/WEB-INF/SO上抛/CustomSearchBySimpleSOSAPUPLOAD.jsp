...
String url = "/formmode/search/CustomSearchBySimpleIframeSOSAPUPLOAD.jsp?"+customidStr+tempquerystring+paramStr+"&mainid="+mainid+"&customTreeDataId="+customTreeDataId;
if(url.indexOf("+")!=-1){
	url = url.replace("+", "%2B");
}
