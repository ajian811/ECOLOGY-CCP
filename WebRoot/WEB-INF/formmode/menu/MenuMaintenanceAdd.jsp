	...
	<wea:item><%=SystemEnv.getHtmlLabelName(18390,user.getLanguage())%></wea:item>
      <wea:item>
        <wea:required id="customMenuNamespan" required="true">
         <INPUT class=InputStyle maxLength=50 name="customMenuName" value="" >
        </wea:required>
      </wea:item><!-- 菜单名称(英文) -->
      ...
      <wea:item>
     	<INPUT class=InputStyle style="width:300px" name="customMenuLink" value="<%=menuaddress %>" title="<%=SystemEnv.getHtmlLabelName(18391,user.getLanguage())%>"><!-- 外部地址请加上http:// -->
