...
if (RecordSet.next() && ExpandBaseRightInfo.checkExpandRight(Util.null2String(RecordSet.getString("id")), modeid)) {
	...
	<table id="topTitle" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td class="rightSearchSpan" style="text-align:right;">
				...
				<%}}else if(isshowshortcutbutton && !methodStr.isEmpty()){%>
...
while (RecordSet.next()) {
	...
	if(temocolwidth==0){
		temocolwidth = avgColWidth;
	}
	if(tempSumWidth>100&&percent!=0){
		temocolwidth = temocolwidth*percent;
	}
...
function dealChineseOfFieldParams(url){
	if(url.indexOf("/workflow/request/AddRequest.jsp")==-1) {
		return url;
	}
	var params = "";
