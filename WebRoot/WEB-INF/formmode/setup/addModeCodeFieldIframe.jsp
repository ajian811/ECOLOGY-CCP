	...
	<wea:group context="<%=SystemEnv.getHtmlLabelName(17998,user.getLanguage()) %>" attributes="{'groupDisplay':'none'}"><!--添加字段  -->
		...
		<wea:item>
			<wea:required id="formfield_span" required="true">
				...
				<% 
					  String sql="select id,fieldlabel,type,fielddbtype,fieldhtmltype,fieldname from workflow_billfield where viewtype=0 and fieldhtmltype not in (2,4,6,7) and billid="+formId;
					  rs.executeSql(sql);
					  while(rs.next()){
