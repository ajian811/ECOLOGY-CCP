...
<wea:layout type="2col">
	...
	<wea:group context="" attributes="{'groupDisplay':'none;'}">
		...
		<wea:item>
			<select name="codeFieldId" style="width: 120px;">
		    <%
			  ...
			  if(rs.next()){
				  ...
				  if ("3".equals(fieldhtmltype)) { //browser框
						if ("161".equals(type)) { //自定义单选
							...
							sb1.append("<option ").append("value='").append("workcode").append("'").append(" selected ").append(" label='").append("人员编号").append("'").append(">").append("人员编号").append("</option>").append("\n");
						} else if ("4".equals(type)) { //部门
							sb1.append("<option ").append("value='").append("departmentcode").append("'").append(" selected ").append(" label='").append("部门编号").append("'").append(">").append("部门编号").append("</option>").append("\n");
						} else if ("164".equals(type)) { //所属分部
							sb1.append("<option ").append("value='").append("subcompanycode").append("'").append(" selected ").append(" label='").append("分部编号").append("'").append(">").append("分部编号").append("</option>").append("\n");
