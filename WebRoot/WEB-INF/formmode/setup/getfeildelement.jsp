...
<select name="con<%=id%>_value">
	<option <%out.print(feildvalue.equals("")?"selected":""); %>  value="">空</option>
	<option <%out.print(feildvalue.equals("1")?"selected":""); %> value="1">是</option>
	<option <%out.print(feildvalue.equals("0")?"selected":""); %> value="0">否</option>
</select>
<%
//=========================================================================================选择框	
}
