...
if("save".equals(action)){
	if(id>0){//修改
		sql = "update mode_layout_querySql set queryType='"+searchconditiontype+"',sqlConetent='"+defaultsql+"',javaFileName='"+javafilename+"' where id = '"+id+"'";
	}else{//新增
		sql = "insert into mode_layout_querySql(modeid,formid,layoutid,detailtype,queryType,sqlConetent,javaFileName) values('"+modeId+"','"+formId+"','"+layoutid+"','"+type+"','"+searchconditiontype+"','"+defaultsql+"','"+javafilename+"')";
	}
	rs.executeSql(sql);
