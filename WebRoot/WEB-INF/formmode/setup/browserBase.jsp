...
rs.executeSql("select isvirtualform from ModeFormExtend where formid="+formID);
int isvirtualform = 0;
if(rs.next()){
...
<tr>
	...
	<td class="e8_tblForm_field">
		<input type="text" name="customname" style="width:80%;" onchange='checkinput("customname","customnamespan")' value="<%=customname %>"/> 
...
<tr>
	...
	<td class="e8_tblForm_field" style="height:76px; vertical-align: top;">
		...
		<div id="SCT_Div_2" class="sctContent" <%if(!searchconditiontype.equals("2")){%>style="display: none;"<%}%>>
			...
			<span class="codeEditFlag2">
				<div class="codeDelFlag" onclick="delJavaCode();" <%if(javafilename.equals("")){%>style="display: none;"<%}%>></div>
			</span>
