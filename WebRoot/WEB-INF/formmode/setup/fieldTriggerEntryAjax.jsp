					...
					<wea:item attributes="{'isTableList':'true','colspan':'full'}">
						...
						<script type="text/javascript">
							...
							jQuery(document).ready(function(){
								...
								var itemhtml3  = "<span class='browser'  _callback='setIndexValue' _callbackParams='<%=index%><%=secIndex%>_#rowIndex#' hasInput='false' name='parawfField<%=index%><%=secIndex%>' getBrowserUrlFn='getModeTableField' isSingle='true' isMustinput='2' getBrowserUrlFnParams='<%=index+"_"+secIndex%>' browserUrl='' _onPropertyChange='showTreenodeid(<%=index%>,<%=secIndex%>,#rowIndex#);'></span>" ;
					...
					<wea:item attributes="{'isTableList':'true','colspan':'full'}">
						...
						<script type="text/javascript">
							...
							jQuery(document).ready(function(){
								...
								var itemhtml3  = "<span class='browser'  _callback='setIndexValue' _callbackParams='<%=index%><%=secIndex%>_#rowIndex#' name='evaluatewfField<%=index%><%=secIndex%>' isSingle='true' getBrowserUrlFn='getModeTableField1' getBrowserUrlFnParams='<%=index+"_"+secIndex%>' isMustinput='2' hasInput='false'></span>";
								var items=[//数据库字段
									{width:"45%",colname:"<%=SystemEnv.getHtmlLabelNames("33510",user.getLanguage())%>",itemhtml:itemhtml1},
									////模块字段
