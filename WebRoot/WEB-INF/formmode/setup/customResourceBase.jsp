										...
										<COLGROUP>
									  	...
									  	<TBODY>
									        ...
									        <TR>
									          	...
									          	<TD class="e8_tblForm_field">
									        		...
									        		<brow:browser viewType="0" id="customSearchId" name="customSearchId" browserValue='<%=customSearchId %>' 
														...
														></brow:browser>
													&nbsp;&nbsp;&nbsp;&nbsp;
													<input class="inputstyle" type="text" id="createUrl" name="createUrl" style="width: 300px;" value="<%=createUrl %>" title="<%=SystemEnv.getHtmlLabelName(18391,user.getLanguage())%>" ><!-- 外部地址请加上http:// -->
									          	</TD>
									        </TR>
									        <TR>
                                            ...
                                            <TR>
                                              ...
                                              <TD class="e8_tblForm_field">
                                                  <select id="resourceFieldId" name="resourceFieldId" style="width:200px;" onpropertychange="changeResource()">
