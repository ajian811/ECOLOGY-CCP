...
<body>
	...
	<div class="e8_right_center">
		...
		<div id="tabs-content-2" class="e8_right_frameContainer">
			<iframe frameborder="0" style="width: 100%;height: 100%;" scrolling="no" lazy-src="/formmode/setup/customSearchField.jsp?id=<%=customSearchId %>">
					
			</iframe>
		</div>
		<div id="tabs-content-3" class="e8_right_frameContainer">
			<iframe frameborder="0" style="width: 100%;height: 100%;" scrolling="auto" lazy-src="/formmode/search/CustomSearchShare.jsp?id=<%=customSearchId %>&formId=<%=formId%>&modeId=<%=modeId%>">
					
			</iframe>
		</div>
		<div id="tabs-content-4" class="e8_right_frameContainer">
			<iframe frameborder="0" style="width: 100%;height: 100%;" scrolling="no" lazy-src="/formmode/batchoperate/ModeBatchSet.jsp?id=<%=customSearchId %>">
