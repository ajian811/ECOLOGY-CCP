...
<!-- 
<tr>
	<td class="e8_tblForm_label" width="20%">ID<div class="e8_label_desc">唯一标识</div></td>
...
<tr>
	...
	<td class="e8_tblForm_field"><input type="checkbox" name="iscustom" value="1" <%if(iscustom==1) out.println("checked='checked'"); %>/></td>
</tr>
<tr>
