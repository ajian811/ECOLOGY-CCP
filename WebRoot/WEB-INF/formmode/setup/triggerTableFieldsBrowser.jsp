 ...
 <script type="text/javascript">
	...
	<div class="e8_box demo2">
		  <div class="e8_boxhead">
		   ...
		   <div class="tab_box">
		        <div>
		            <iframe src="triggerTableFieldsBrowserIframe.jsp?searchtablename=<%=searchtablename%>&searchfieldname=<%=searchfieldname%>&datasourceid=<%=datasourceid%>&tablenames=<%=tablenames%>" onload="if(typeof(update)=='function'){update()}" id="tabcontentframe" name="tabcontentframe" class="flowFrame" frameborder="0" height="100%" width="100%;"></iframe>
		        </div>
		   </div>
	</div> 
