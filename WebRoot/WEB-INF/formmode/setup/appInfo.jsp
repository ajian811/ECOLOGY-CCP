...
if(operatelevel>0){
	...
	RCMenu += "{"+SystemEnv.getHtmlLabelName(81994,user.getLanguage())+",javascript:preImportApp("+appId+"),_self} " ;//导入应用
	RCMenuHeight += RCMenuHeightStep;
	
	RCMenu += "{"+SystemEnv.getHtmlLabelName(81998,user.getLanguage())+",javascript:exportApp("+appId+"),_self} " ;//导出应用
	RCMenuHeight += RCMenuHeightStep;
	
	if(formModeConfig.isImportchecksametable()){
		RCMenu += "{"+SystemEnv.getHtmlLabelName(81995,user.getLanguage())+",javascript:preImportModel("+appId+"),_self}" ;//导入模块
		RCMenuHeight += RCMenuHeightStep;
	}
	...
	<div class="elementPart">
		...
		<div class="content">
			<ul class="component">
				...
				<li class="color2" style="background-image: url('/formmode/images/appbar/appbar.table.select_wev8.png');" onclick="javascript:clickTopSubMenu(5);">
					<div class="bottomInfo">
						<div class="label"><%=SystemEnv.getHtmlLabelName(32306,user.getLanguage())%><!-- 浏览框 --><span id="component5" class="count"></span></div>
					</div>
				</li>
				<li class="color2" style="background-image: url('/formmode/images/appbar/appbar.diagram_wev8.png');" onclick="javascript:clickTopSubMenu(6);">
					<div class="bottomInfo">
...
<td>
<div id="appPart3" class="appPart" style="display: <%=formModeConfig.isImportchecksametable()?"none":""%>">
	<div class="elementPart">
		<div class="title"><%=SystemEnv.getHtmlLabelName(31919,user.getLanguage())%><!-- 模块导入 --></div>
		<div class="content">
