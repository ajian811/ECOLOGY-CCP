...
<script type="text/javascript">
    ...
    function onClean() {
    	...
    	if (!!$("#mainExpression").html()) {
    		top.Dialog.confirm('确定清空所有条件？', function() {
    			_doClean();
    		});
    	} else {
    		_doClean();
...
var dialog = window.parent.parent.getDialog(parent);
    ...
    <body>
		        				...
		        				<TR >
		        					...
		        					<td >
		        						<select class=inputstyle   style="width:80px;" name="conditiontype" id="conditiontype" title="<%=SystemEnv.getHtmlLabelName(15620,user.getLanguage())%>" 
											...
											<option value="1" <%if(conditiontype==1){%>selected="selected"<%} %> >普通类型</option>
			        		...
			        		<td class="td_3">
			        			...
			        			<span class="valueSpan" name="valueSpan5" style="display:none;"><!-- select框控件 -->
			                    	<span name="textSpan5" style="padding-left:0px;">
			                    		<select type="text" name="textvalue5" style="width:100px">
			...
			<div id="ruleContent" style="width:100%;height:400px;overflow:auto;<%=ruleContentCss %>">
                <div style="margin-top: 15px;margin-bottom: 15px;margin-left:20px;" id="expressionBlock">
	                ...
	                <div id="mainBlock" class="relationblock" style="display:none;" key="-9">
						<div class="verticalblock" onmouseover="relatmouseover(this)" title="双击编辑" onmouseout="relatmouseout(this)" ondblclick="switchRelationEditMode(event,this)">&nbsp;AND&nbsp;</div>
            	...
            	<table style="width: 90%;" border="0" align="center">
            		...
            		<tr>
            			...
            			<td>
            				...
            				<br>
            				格式为：table1.a='1' and table2.b='2'，其中table1,table2为数据库表名  a,b为字段名
            				<br>
            				主表：&nbsp;&nbsp;<%=mainTablename %>
            				<%
		...
		<div id="ruledescBtn">
			<input type="button" id="ruledescBtn_btn" class="operbtn operbtn_up" name="paramdelete" style="" title="显示" value=" " onclick="showSql();">
		</div>
