...
String tableString=""+
			  "<table  pagesize=\""+perpage+"\" tabletype=\"none\">"+
				  ...
				  "<head>"+                    
				  		  //流程类型
						  "<col width=\"30%\"  text=\""+SystemEnv.getHtmlLabelName(16579,user.getLanguage())+"\" column=\"workflowid\" orderkey=\"workflowid\" transmethod=\"weaver.formmode.interfaces.WfToModeTransmethod.getWorkflowName\" otherpara=\""+user.getLanguage()+"\"/>"+
						  //模块名称
