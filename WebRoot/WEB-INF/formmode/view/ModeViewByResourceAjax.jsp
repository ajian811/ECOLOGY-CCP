...
String sql = "select c.* from "+resourceTablename+" c where 1=1 " +sqlwhere+ " order by id";
if(!rightsql.equals("")){
	sql = "select c.* from "+resourceTablename+" c,"+rightsql+" t2 where c.id = t2.sourceid " +sqlwhere+ " order by id";
}
