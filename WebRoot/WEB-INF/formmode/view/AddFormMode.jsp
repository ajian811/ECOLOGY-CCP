...
if(!"id".equals(pkfield)&&!"".equals(pkfield)){//当设置了主键时，重新解析billid
	...
	try {
		rs.executeSql("select id from "+table+" where "+pkfield+"='"+billid+"'");
		if(rs.next()){
...
//处理特殊值
String iframeurl = "/formmode/view/AddFormModeIframe.jsp?modeId="+modeId+"&formId="+formId+"&type="+type+"&billid="+billid+"&customid="+customid+"&isdialog="+isDialog+"&templateid="+templateid+"&isclose="+isclose+"&mainid="+mainid;
Enumeration<String> pNames = request.getParameterNames();
while(pNames.hasMoreElements()){
	String pName = pNames.nextElement();
	String pValue = request.getParameter(pName);
	if(!("modeId".equals(pName)||"formId".equals(pName)||"type".equals(pName)||"billid".equals(pName)||"customid".equals(pName))){
