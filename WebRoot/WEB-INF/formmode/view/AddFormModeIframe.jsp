...
int PreviewLayoutId = Util.getIntValue(request.getParameter("layoutId"),0);//预览的布局ID
                              ...
                              if (tfieldidarray[1]==isdetail){
                               if(rownum>-1){ 
                                               if($GetEle('field'+tfieldidarray[0]+rownum+'span')!=null){
                                                  $('#field'+tfieldidarray[0]+rownum+'span').css('display','none');
                                               }
                                               if($GetEle('field'+tfieldidarray[0]+"_"+rownum+'_browserbtn')!=null){
                                                    $('#field'+tfieldidarray[0]+"_"+rownum+'_browserbtn').css('display','none');
													if($GetEle('field'+tfieldidarray[0]+"_"+rownum+'wrapspan')!=null){
													  $('#field'+tfieldidarray[0]+"_"+rownum+'wrapspan').css('display','none');
													}
                                                }
                                            	if($GetEle('field'+tfieldidarray[0]+'_'+rownum)!=null){
                                                    $('#field'+tfieldidarray[0]+'_'+rownum).css('display','none');        	
                                                }
												if($GetEle('field_lable'+tfieldidarray[0]+'span_'+rownum)!=null){
												   $('#field_lable'+tfieldidarray[0]+'span_'+rownum).css('display','none'); 
												}
												if($GetEle('field_lable'+tfieldidarray[0]+'_'+rownum)!=null){
												   $('#field_lable'+tfieldidarray[0]+'_'+rownum).css('display','none'); 
												}if($GetEle('field_chinglish'+tfieldidarray[0]+'span_'+rownum)!=null){
												   $('#field_chinglish'+tfieldidarray[0]+'span_'+rownum).css('display','none'); 
												}
												if($GetEle('field_chinglish'+tfieldidarray[0]+'_'+rownum)!=null){
												   $('#field_chinglish'+tfieldidarray[0]+'_'+rownum).css('display','none'); 
												}
                                            	//判断附件字段
                                             ...
                                             if($GetEle('field'+tfieldidarray[0]+"span")!=null){
                                                  $('#field'+tfieldidarray[0]+"span").css('display','none');
                                               }
                                               if($GetEle('field'+tfieldidarray[0]+"_browserbtn")!=null){
											        if($('#field'+tfieldidarray[0]+'_browserbtn').closest('.e8_os').css('display')!='none'){
													   $('#field'+tfieldidarray[0]+'_browserbtn').closest('.e8_os').css('display','none');
													}
                                                }
                                            	if($GetEle('field'+tfieldidarray[0])!=null){
                                                    $('#field'+tfieldidarray[0]).css('display','none');        	
                                                }
												if($GetEle('field_lable'+tfieldidarray[0]+'span')!=null){
												   $('#field_lable'+tfieldidarray[0]+'span').css('display','none'); 
												}
												if($GetEle('field_lable'+tfieldidarray[0])!=null){
												   $('#field_lable'+tfieldidarray[0]).css('display','none'); 
												}if($GetEle('field_chinglish'+tfieldidarray[0]+'span')!=null){
												   $('#field_chinglish'+tfieldidarray[0]+'span').css('display','none'); 
												}
												if($GetEle('field_chinglish'+tfieldidarray[0])!=null){
												   $('#field_chinglish'+tfieldidarray[0]).css('display','none'); 
												}
                    ...
                    if(fieldattr==-1){ // 没有设置联动，恢复原值和恢复原显示属性
                        for(i=0;i<len;i++){
                            for(j=0;j<fieldidarray.length;j++){
                                var tfieldidarray=fieldidarray[j].split("_");
								//影藏 明细
								               if($('#field'+tfieldidarray[0]+rownum+'span').css('display')=='none'){
                                                  $('#field'+tfieldidarray[0]+rownum+'span').css('display','');
                                               }
                                               if($('#field'+tfieldidarray[0]+"_"+rownum+'wrapspan').css('display')=='none'){
                                                    $('#field'+tfieldidarray[0]+"_"+rownum+'_browserbtn').css('display','');
													 $('#field'+tfieldidarray[0]+"_"+rownum+'wrapspan').css('display','');
                                                }
                                            	if($('#field'+tfieldidarray[0]+'_'+rownum).css('display')=='none'){
                                                    $('#field'+tfieldidarray[0]+'_'+rownum).css('display','');        	
                                                }
												if($('#field_lable'+tfieldidarray[0]+'span_'+rownum).css('display')=='none'){
												   $('#field_lable'+tfieldidarray[0]+'span_'+rownum).css('display',''); 
												}
												if($('#field_lable'+tfieldidarray[0]+'_'+rownum).css('display')=='none'){
												   $('#field_lable'+tfieldidarray[0]+'_'+rownum).css('display',''); 
												}if($('#field_chinglish'+tfieldidarray[0]+'span_'+rownum).css('display')=='none'){
												   $('#field_chinglish'+tfieldidarray[0]+'span_'+rownum).css('display',''); 
												}
												if($('#field_chinglish'+tfieldidarray[0]+'_'+rownum).css('display')=='none'){
												   $('#field_chinglish'+tfieldidarray[0]+'_'+rownum).css('display',''); 
												}
                                            	//判断附件字段
											 ...
											 //主表
								              if($('#field'+tfieldidarray[0]+"span").css('display')=='none'){
                                                  $('#field'+tfieldidarray[0]+"span").css('display','');
                                               }
                                               if($('#field'+tfieldidarray[0]+'_browserbtn').closest('.e8_os').css('display')=='none'){
													   $('#field'+tfieldidarray[0]+'_browserbtn').closest('.e8_os').css('display','block');
												}
                                            	if($('#field'+tfieldidarray[0]).css('display')=='none'){
                                                    $('#field'+tfieldidarray[0]).css('display','');        	
                                                }
												if($('#field_lable'+tfieldidarray[0]+'span').css('display')=='none'){
												   $('#field_lable'+tfieldidarray[0]+'span').css('display',''); 
												}
												if($('#field_lable'+tfieldidarray[0]).css('display')=='none'){
												   $('#field_lable'+tfieldidarray[0]).css('display',''); 
												}if($('#field_chinglish'+tfieldidarray[0]+'span').css('display')=='none'){
												   $('#field_chinglish'+tfieldidarray[0]+'span').css('display',''); 
												}
												if($('#field_chinglish'+tfieldidarray[0]).css('display')=='none'){
												   $('#field_chinglish'+tfieldidarray[0]).css('display',''); 
												}
								//
                                if (tfieldidarray[1]==isdetail){
                                    if(rownum>-1){  // 明细字段
...
function showFormModeMap(fieldid){
	var dialogurl = "/systeminfo/BrowserMain.jsp?url="+escape("/formmode/view/FormModeMap.jsp?fieldid="+fieldid);
	var dialog = new window.top.Dialog();
	dialog.currentWindow = window;
	dialog.URL = dialogurl;
	dialog.Width = 800 ;
