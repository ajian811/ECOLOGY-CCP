		            ...
		            <td style="padding: 5px 5px 2px; border: 1px solid rgb(218, 218, 218); background-color: rgb(247, 252, 253);" colspan="2">
	                     <table style="width: 100%; table-layout: fixed;" cellspacing="0" cellpadding="0">
	                         ...
	                         <tbody>
	                         	<tr>
		                             <td colspan="2">
		                                <span style="color: rgb(153, 153, 153);">引用&nbsp;<%=quo_floornum%>#</span>&nbsp;&nbsp;
				       			 ...
				       			 <div>
					       			   <div class="fmLeft">
					       			 		...
					       			 		<%if(!comm_commentusersid.equals("0")){%>
					       			 			<span class="fmtime">回复</span>&nbsp;<a href="javascript:void(0)" class="fmOptName" onclick="pointerXY(event);openhrm('<%=comm_commentusersid%>');return false;">
					       			 	...
					       			 	<div class="fmRight">
					       			 		<%if(isOptPer){%>
					       			 			<a href="javascript:void(0)" title="删除" class="fmCommentDelete" onclick="deleteComment(this,'<%=comm_id%>','reply');return false;" ></a>
					       			 		<%}%>
					       			 		<a href="javascript:void(0)" title="评论" class="fmCommentReply" onclick="showReplay('<%=id%>','reply','<%=comm_id%>','<%=comm_replyor%>');return false;"></a>	
					       			 	</div>
				  ...
				  <tr>
		           	 <td align="right" colspan="2">
	           			...
	           			<div align="right" class="fmOperations" style="border: 0px currentColor; background-color: rgb(255, 255, 255);">
	           				  ...
	           				  <%}%>
						      <a class="fmQuote fmItem fmReplayLink" onclick="showReplay('<%=id%>','quotes');return false;" href="javascript:void(0)">引用</a><!-- 引用 -->
							  <a class="fmComment fmItem fmReplayLink" onclick="showReplay('<%=id%>','comment');return false;" href="javascript:void(0)">评论</a><!-- 回复 -->
	                 	</div>
		           	 </td>
				   </tr>
				        ...
				        <td colspan="2">
		           			<div class="fmReplaydiv" id="replay_364477" style="display: block;">
			    				...
			    				<div style="margin: 3px 0px 3px 0px;">
			    					<iframe id="replyFrame_<%=id%>" name="replyFrame_<%=id%>" frameborder="0" style="width: 100%;" scrolling="no" src="" onload="setIframeHeight('replyFrame_<%=id%>');">
