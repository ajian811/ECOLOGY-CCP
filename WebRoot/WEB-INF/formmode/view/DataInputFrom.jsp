...
for(int temp=0; temp < triggerfieldnameArr.size();temp++){
    ...
    try{
        ...
        //System.out.println("t = "+t+" trgv_s = "+trgv_s+" triggerfieldV = "+triggerfieldV+" istriggerdetail = "+istriggerdetail);
        ...
        while(rs.next()){
            ...
            while(rs1.next()){
                ...
                for(int i=0;i<infieldnamelist.size();i++){
                	...
                	System.out.println(datainputid+"|"+(String)infieldnamelist.get(i)+"===="+treenodeid+"|"+value);
...
<%
                ...
                for(int dtidx = 0 ; dtidx < groupids.size() ; dtidx++){
                    ...
                    System.out.println("groupids ="+groupids.get(dtidx).toString()+" DDI.GetIsCycle()="+DDI.GetIsCycle()+"  outdatasList.size = "+outdatasList.size()+"  outfieldnamelist.size = "+outfieldnamelist.size());
                    for(int i=0;i<outdatasList.size();i++){
                    outdatahash = (Hashtable)outdatasList.get(i);
                    %>
                    try{
