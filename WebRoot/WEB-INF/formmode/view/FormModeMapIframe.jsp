...
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=EtnGWaHc72ueHj0lXNbh2jwm"></script>
<style type="text/css">
.searchText_tip{
	position: absolute;
	top: 7px;
...
<div style="height: 30px;position:absolute;  z-index:1;float:right; top: 30px;left: 60px;" >
	<div class="searchText_tip">搜索地址....</div>
	...
	id="zd_btn_save" 
	class="e8_btn_top_first" title="搜索"  value="搜索" type="button">
</div>
