...
if (sqlcontent.toUpperCase().indexOf("INSERT") > -1 || sqlcontent.toUpperCase().indexOf("UPDATE") > -1 
		|| sqlcontent.toUpperCase().indexOf("DROP") > -1|| sqlcontent.toUpperCase().indexOf("TRUNCATE") > -1
		|| sqlcontent.toUpperCase().indexOf("DELETE") > -1|| sqlcontent.toUpperCase().indexOf("EXEC") > -1
		|| sqlcontent.toUpperCase().indexOf("CALL") > -1){
 		return ;
}
