...
String isDialog = Util.null2String(request.getParameter("isdialog"));
	...
	if(user.getLanguage()==8){
		title+=  	"<li>"+"1,Please calculate the formula in the text area to define current asset value, <br / > to #< field name > reference field value balance sheet."+"</li>";
		title+=  	"<li>"+"2,References to the asset table field values are only supported by the numerical class."+"</li>";
		title+=  	"<li>"+"3,You can double click on the right side of the box to display the field shortcut input."+"</li>";
		title+=  	"<li>"+"4,The general expressions of support +, -, *, /, brackets, figures, <br /> support four hybrid operation."+"</li>";
		title+=  	"<li>"+"5,Formula expression parsing error will prompt, unable to save."+"</li>";
	}else if(user.getLanguage()==9){
		title+=  	"<li>"+"1、請在文字區域定義資產現值的計算公式，<br />以#<欄位名>的管道引用資產錶欄位值。"+"</li>";
		title+=  	"<li>"+"2、引用資產錶欄位值只支持數值類的欄位。"+"</li>";
		title+=  	"<li>"+"3、可以按兩下右邊選擇框裏顯示的欄位快捷輸入。"+"</li>";
		title+=  	"<li>"+"4、公式運算式支持+、-、*、/、括弧、數位等，<br />支持四則混合運算。"+"</li>";
		title+=  	"<li>"+"5、公式運算式解析錯誤會提示，無法保存。"+"</li>";
	}else{
		title+=  	"<li>"+"1、请在文本区域定义资产现值的计算公式，<br />以#&lt;字段名&gt;的方式引用资产表字段值。"+"</li>";
		title+=  	"<li>"+"2、引用资产表字段值只支持数值类的字段。"+"</li>";
		title+=  	"<li>"+"3、可以双击右边选择框里显示的字段快捷输入。"+"</li>";
		title+=  	"<li>"+"4、公式表达式支持+、-、*、/、括号、数字等，<br />支持四则混合运算。"+"</li>";
		title+=  	"<li>"+"5、公式表达式解析错误会提示，无法保存。"+"</li>";
	}
	title+= "</ul>";
