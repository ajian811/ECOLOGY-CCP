...
<IFRAME name=leftframe id=leftframe src="/formmode/tree/CustomTreeLeft.jsp?id=<%=id%>&searchkeyname=<%=URLEncoder.encode(searchkeyname,"utf-8") %>" width="100%" height="100%" frameborder=no scrolling=auto>
