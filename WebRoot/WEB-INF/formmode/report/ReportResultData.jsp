...
<tr>
<td>
<TABLE class=ListStyle cellspacing=1 id="reportDateTbl" name="reportDateTbl" style="table-Layout:fixed;">
  <COLGROUP>
  <thead>
  ...
  <%
   ...
   %>
   <%if (statcount!=0) {er.addValue("");%><TH style="height: 38px;width:5%"></TH><%} %>
   <%
