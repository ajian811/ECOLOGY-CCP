    ...
    <td colspan=3>
         <%
            ...
            if(type.equals("4") && sharelevel <2) {
                ...
                onclickFun = "onShowBrowser('"+id+"','"+browserurl+"')";
...
%>
    ...
    <td colspan=3> <button type=button  class=Browser  onfocus="changelevel('<%=tmpcount%>')" onclick="onShowBrowser('<%=id%>','/systeminfo/BrowserMain.jsp?url=/hrm/resource/MutiResourceBrowser.jsp')"></button>
      <input type=hidden name="con<%=id%>_value" >
      <input type=hidden name="con<%=id%>_name" >
      <span name="con<%=id%>_valuespan" id="con<%=id%>_valuespan">
      </span> </td>
...
%>
    ...
    <td colspan=3> <button type=button  class=Browser  onfocus="changelevel('<%=tmpcount%>')" onclick="onShowBrowser('<%=id%>','/systeminfo/BrowserMain.jsp?url=/hrm/roles/MutiRolesBrowser.jsp')"></button>
      <input type=hidden name="con<%=id%>_value" >
      <input type=hidden name="con<%=id%>_name" >
      <span name="con<%=id%>_valuespan" id="con<%=id%>_valuespan">
      </span> </td>
...
%>
    <td >
     ...
     <td colspan=3> <button type=button  class=Browser  onfocus="changelevel('<%=tmpcount%>')" onclick="onShowBrowser('<%=id%>','/systeminfo/BrowserMain.jsp?url=/CRM/data/MutiCustomerBrowser.jsp')"></button>
      <input type=hidden name="con<%=id%>_value" >
      <input type=hidden name="con<%=id%>_name" >
      <span name="con<%=id%>_valuespan" id="con<%=id%>_valuespan">
      </span> </td>
    ...
    <td >
     ...
     <td colspan=3> <button type=button  class=Browser  onfocus="changelevel('<%=tmpcount%>')" onclick="onShowBrowser('<%=id%>','/systeminfo/BrowserMain.jsp?url=/docs/docs/MutiDocBrowser.jsp')"></button>
      <input type=hidden name="con<%=id%>_value" >
      <input type=hidden name="con<%=id%>_name" >
      <span name="con<%=id%>_valuespan" id="con<%=id%>_valuespan">
      </span> </td>
...
%>
    ...
    <td colspan=3> <button type=button  class=Browser  onfocus="changelevel('<%=tmpcount%>')" onclick="onShowBrowser('<%=id%>','/systeminfo/BrowserMain.jsp?url=/proj/data/MultiProjectBrowser.jsp')"></button>
      <input type=hidden name="con<%=id%>_value" >
      <input type=hidden name="con<%=id%>_name" >
      <span name="con<%=id%>_valuespan" id="con<%=id%>_valuespan">
      </span> </td>
...
%>
    ...
    <td colspan=3> <button type=button  class=Browser  onfocus="changelevel('<%=tmpcount%>')" onclick="onShowBrowser('<%=id%>','/systeminfo/BrowserMain.jsp?url=/hrm/company/MutiDepartmentBrowser.jsp')"></button>
      <input type=hidden name="con<%=id%>_value" >
      <input type=hidden name="con<%=id%>_name" >
      <span name="con<%=id%>_valuespan" id="con<%=id%>_valuespan">
      </span> </td>
...
%>
    ...
    <%
		...
		browserurl = browserurl.trim() + "?type="+dbtype+"_"+type;
    %>
    <td colspan=3> <button type=button  class=Browser  onfocus="changelevel('<%=tmpcount%>')" onclick="onShowBrowser('<%=id%>','<%=browserurl%>',<%=type %>)"></button>
      <input type=hidden name="con<%=id%>_value"  value="">
      <input type=hidden name="con<%=id%>_name" >
      <span name="con<%=id%>_valuespan" id="con<%=id%>_valuespan">
      </span> </td>
