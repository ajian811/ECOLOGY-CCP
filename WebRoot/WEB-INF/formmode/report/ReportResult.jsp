...
if(checkcons!=null){
	...
	if(rs4.getDBType().equals("oracle")){
		rs4.execute("select mo.* from mode_ReportDspField mo left join workflow_billfield wo on wo.id = mo.fieldid where mo.reportid = "+reportid+" and mo.isshow=1 order by mo.dsporder asc,wo.detailtable desc,mo.id asc");
    }else{
    	rs4.execute("select * from mode_ReportDspField where reportid = "+reportid+" and isshow=1 order by dsporder,id asc");
    }
