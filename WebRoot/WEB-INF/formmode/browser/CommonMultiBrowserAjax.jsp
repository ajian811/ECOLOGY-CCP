...
<%!
//安装指定顺序排序
private static void sort(JSONArray ja,final String field ,final String keyss){
Collections.sort(ja, new Comparator<JSONObject>() {
	@Override
	public int compare(JSONObject o1, JSONObject o2) {
		Object f1 = o1.get(field);
		Object f2 = o2.get(field);
		int index1 = keyss.indexOf(f1.toString());
		int index2 = keyss.indexOf(f2.toString());
		if(index1<index2){
			return 0;
		}else{
			return 1;
