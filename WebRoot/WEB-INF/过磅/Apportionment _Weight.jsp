	...
	try {
				...
				if(rs.next()){
					...
					if(!gh.equals("")){
						...
						return;
							...
							sql = "INSERT INTO UF_GBJL (CP,GBRQ,GBSJ,RZ,GH) VALUES (";
				...
				if (sfdy.equals("0")) {
					...
					while (rs.next()) {
						...
						if (count == 0) {
							...
							String gbrq = currentDate.substring(0, 10);
							String gbsj = currentDate.substring(11, 16);
							String sql3 = "insert into UF_GBJL (ZXJHH,CP,SHIPPING,GBRQ,GBSJ,RZ,CZ) values (";
							sql3 += "'" + zxjhh + "',";
							sql3 += "'" + carno + "',";
							sql3 += "'" + shipping + "',";
							sql3 += "'" + gbrq + "',";
		...
		if ("insertGB".equals(action)) {
			...
			if(weighType.equals("weighkg")){
				...
				if(rs.next()){
					...
					return;
							...
							String gbrq = currentDate.substring(0, 10);
							String gbsj = currentDate.substring(11, 16);
							sql = "INSERT INTO UF_GBJL (CP,GBRQ,GBSJ,CZ,GH) VALUES (";
			...
			SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm");
							...
							String gbrq = currentDate.substring(0, 10);
							String gbsj = currentDate.substring(11, 16);
							String sql4 = "insert into UF_GBJL (ZXJHH,CP,SHIPPING,GBRQ,GBSJ,RZ,CZ,JZ,TRDH) values (";
							sql4 += "'" + zxjhh + "',";
							sql4 += "'" + carno + "',";
							sql4 += "'" + shipping + "',";
							sql4 += "'" + gbrq + "',";
